...
#ifndef MyAliFlowAnalysisWithMCEventPlane_H
#define MyAliFlowAnalysisWithMCEventPlane_H
...
class MyAliFlowAnalysisWithMCEventPlane {

 public:

   MyAliFlowAnalysisWithMCEventPlane();            //default constructor
   virtual  ~MyAliFlowAnalysisWithMCEventPlane();  //destructor
 ...
 private:
   ...
   MyAliFlowAnalysisWithMCEventPlane(const MyAliFlowAnalysisWithMCEventPlane& aAnalysis);             //copy constructor
   MyAliFlowAnalysisWithMCEventPlane& operator=(const MyAliFlowAnalysisWithMCEventPlane& aAnalysis);  //assignment operator
   ...
   TProfile*    fHistProDiffFlowEtaPOICh; // profile used to calculate the differential flow (Eta) of POI particles
   ...
   ClassDef(MyAliFlowAnalysisWithMCEventPlane,0)  // Analyse particle distribution versus MC reaction plane
