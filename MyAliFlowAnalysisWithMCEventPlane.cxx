...
**************************************************************************/
// MyAliFlowAnalysisWithMCEventPlane:
...
#define MyAliFlowAnalysisWithMCEventPlane_cxx
...
#include "MyAliFlowAnalysisWithMCEventPlane.h"
...
using std::endl;
using std::cout;
ClassImp(MyAliFlowAnalysisWithMCEventPlane)

  //-----------------------------------------------------------------------

 MyAliFlowAnalysisWithMCEventPlane::MyAliFlowAnalysisWithMCEventPlane():
   fQsum(NULL),
   fQ2sum(0),
   fEventNumber(0),
   fDebug(kFALSE),
...
void MyAliFlowAnalysisWithMCEventPlane::WriteHistograms(TString* outputFileName)
{
...
void MyAliFlowAnalysisWithMCEventPlane::WriteHistograms(TDirectoryFile *outputFileName)
{
 //store the final results in output .root file
 fHistList->SetName("cobjMCEP");
 fHistList->SetOwner(kTRUE);
...
//-----------------------------------------------------------------------
void MyAliFlowAnalysisWithMCEventPlane::Init() {
...
void MyAliFlowAnalysisWithMCEventPlane::Make(AliFlowEventSimple* anEvent) {
...
void MyAliFlowAnalysisWithMCEventPlane::GetOutputHistograms(TList *outputListHistos) {
...
void MyAliFlowAnalysisWithMCEventPlane::GetOutputHistoramsForMixedHarmonics(TList *mixedHarmonicsList)
{
...
} // end of void MyAliFlowAnalysisWithMCEventPlane::GetOutputHistoramsForMixedHarmonics(TList *mixedHarmonicsList)

//--------------------------------------------------------------------

void MyAliFlowAnalysisWithMCEventPlane::Finish() {

  //*************make histograms etc.
  if (fDebug) cout<<"MyAliFlowAnalysisWithMCEventPlane::Terminate()"<<endl;
...
void MyAliFlowAnalysisWithMCEventPlane::InitalizeArraysForMixedHarmonics()
{
...
void MyAliFlowAnalysisWithMCEventPlane::BookObjectsForMixedHarmonics()
{
...
} // end of void MyAliFlowAnalysisWithMCEventPlane::BookObjectsForMixedHarmonics()

//-----------------------------------------------------------------------

void MyAliFlowAnalysisWithMCEventPlane::EvaluateMixedHarmonics(AliFlowEventSimple* anEvent)
{
...
} // end of void MyAliFlowAnalysisWithMCEventPlane::EvaluateMixedHarmonics()
