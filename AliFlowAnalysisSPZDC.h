...
#ifndef AliFlowAnalysisSPZDC_H
#define AliFlowAnalysisSPZDC_H
...
class AliFlowAnalysisSPZDC : public TNamed {
public:
  AliFlowAnalysisSPZDC(const char* name="AliFlowAnalysisSPZDC",
                       Int_t nCen=7,
                       Double_t CenWidth=10.);
  virtual ~AliFlowAnalysisSPZDC();
  ...
  virtual void CalculateFlowSPZDC(Double_t ZCRe, Double_t ZCIm, Double_t ZARe, Double_t ZAIm, Double_t dPhi, Double_t dEta, Double_t dPt, Double_t wPhiEta, Double_t dCharge, Int_t dCnt, Double_t MCA, Double_t MCC);
...
private:
  ...
  AliFlowAnalysisSPZDC(const AliFlowAnalysisSPZDC& afawQc);
  AliFlowAnalysisSPZDC& operator=(const AliFlowAnalysisSPZDC& afawQc);
...
//  TH1D *fFlowQCIntCorHistOrdMag[fFlowNHarm][fkNOrdMag][fkNHistOrdMag]; //!
  ...
  ClassDef(AliFlowAnalysisSPZDC,70);
